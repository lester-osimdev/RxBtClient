package com.osim.rxbtclient.util;

import java.util.Locale;

/**
 * Created by RaynetEngineer on 7/4/2016.
 */
public class CHexConver {
    ...
    public static int convertTwoBytesToInt(byte byte0, byte byte1) {
        byte[] array = new byte[2];
        array[0] = byte0;
        array[1] = byte1;
        return Integer.parseInt(byte2HexStr(array, 2).replace(" ", ""), 16);
    }
}
